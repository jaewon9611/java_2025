package com.thejoa.boot008.util3.naver_mail;
...
public class NaverMail {
	...
	public void sendMail(String subject,String content) {
		...
		String user = "wodnjs0610@naver.com"; //naver아이디 cozizii@naver.com
		String password = "k1045212@"; // naver 비밀번호
		...
		props.put("mail.smtp.starttls.enable", "true");     // 이메일 전송시 보안연결사용
