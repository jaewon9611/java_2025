...
class Farm {
	...
	int    age;  // 인스턴스변수 - heap area - new ) - this.age
...
public class Class005_static {
	public static void main(String[] args) {
		...
		Farm cat = new Farm(); cat.name="navi"; cat.age=10; cat.show();
...
#1.		Farm.class / Class005.class  - main/ Farm.FarmName[(주)동물농장], Farm.num[10] , num_plus()
---------------------------------------------
[heap]                        | [stack]
