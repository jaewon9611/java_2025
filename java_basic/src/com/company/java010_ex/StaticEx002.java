...
class Mobile2 {
	static int count = 0; //클래스 변수 - method -new X - static (공용) - 바로사용가능
...
/*
------------------------------- runtime 
[method: 각종정보, static, final/공유] ##1. Moblie.class / StaticEx002.class , count[4]
---------------------------------------------
[heap]                       | [stack]
13번 : {serialNo :2030-1}   ← m4
12번 : {serialNo :2030-1}   ← m3
11번 : {serialNo :2030-1}   ← m2
