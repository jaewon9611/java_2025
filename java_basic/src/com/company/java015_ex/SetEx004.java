...
class Score {
	...
	@Override public boolean equals(Object obj) {
		...
		Score other = (Score) obj; return eng == other.eng && kor == other.kor && math == other.math && Objects.equals(name, other.name); }
...
public class SetEx004 {
	public static void main(String[] args) {
		...
		//> 갯수는 3개로 나오게 만들기
		Iterator<Score> iter = scores.iterator(); // set모으기
		while(iter.hasNext()) {// 2. 처리대상확인
			...
			+ temp.getEng() + "\t" + temp.getMath()+ "\t" +total+ "\t" +String.format("%.2f", avg));
		}
