...
public class NetWork003_book {
	public static void main(String[] args) {
		...
		conn.setRequestProperty("X-Naver-Client-Id", "q2PdH34X769A5z9_Fq7O");
		conn.setRequestProperty("X-Naver-Client-Secret", "srEH2YsnEf");
...
#1
Client ID 		q2PdH34X769A5z9_Fq7O
Client Secret   srEH2YsnEf
