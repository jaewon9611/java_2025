...
public class Lambda004_api {
	public static void main(String[] args) {
		...
		// () ->{return} 파라미터X / 리턴값 O
		//Supplier<String> supplier= () -> {return "Hello";}; //##채우기
		...
		System.out.println(function.apply("10") + 3); // 13 문자열 숫자 Integer.parseInt()
		...
		System.out.println(operator.applyAsInt(10, 3)); // 10 큰값 리턴
