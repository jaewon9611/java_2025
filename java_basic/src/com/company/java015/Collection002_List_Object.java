...
public class Collection002_List_Object {
	public static void main(String[] args) {
		//2. Milk 자료형으로 ArrayLise 동적배열만들기 milks
		List<Milk> milks = new ArrayList<>();
		
		//3. data넣기
		milks.add(new Milk(1, "white", 1200));
		milks.add(new Milk(1, "choco", 1400));
		milks.add(new Milk(1, "banana", 1500));
		
		//4. 출력
		// for + size
//		for(int i=0; i<milks.size(); i++) {
//			Milk temp = milks.get(0); // milks.get(0); milks.get(1); milks.get(2);
