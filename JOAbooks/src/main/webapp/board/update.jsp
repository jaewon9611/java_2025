...
<div class="container card  my-5   p-3">
	...
	<form action="#" method="post"  id="writeForm"   onsubmit="return  form()">
		...
		<div class="my-3  text-end">
			<input type="submit"   value="입력"  class="btn btn-primary my-3" style="dispaly:block"   >  
			<input type="reset"    value="취소"  class="btn btn-outline-primary btn-block my-3" style="dispaly:block"    >  
			<a href="list.jsp"   class="btn btn-outline-primary btn-block my-3" style="dispaly:block"  >목록보기</a>
		</div>	
	</form> <!-- end form -->	
	<script>
	function form(){  
