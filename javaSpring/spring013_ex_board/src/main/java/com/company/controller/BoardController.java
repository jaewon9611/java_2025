 ...
 * 
 * @RequestMapping(value="/board/create" , method=RequestMethod.GET) public
 * String create() {return "board/write";}
 * 
 * @RequestMapping(value="/board/create" , method=RequestMethod.POST) public
 * String create_post() {return "board/write";}
 * 
 * @RequestMapping(value="/board/detail" ,method=RequestMethod.GET ) public
 * String detail() {return "board/detail";}
 * 
 * @RequestMapping(value = "/board/edit" , method = RequestMethod.GET) public
 * String edit() {return "board/edit";}
 * 
 * @RequestMapping(value = "/board/edit" , method = RequestMethod.POST) public
 * String edit_post() {return "board/edit";}
 * 
 * @RequestMapping(value = "/board/delete" , method = RequestMethod.GET) public
 * String delete() {return "board/delete";}
 * 
 * @RequestMapping(value = "/board/delete" , method = RequestMethod.POST) public
 * String delete_post() {return "board/delete";} }
 */
//{
//	@RequestMapping("/") 
...
//	public String basic1( Model model) { // 泥섎━寃곌낵瑜� Model 媛앹껜�뿉 �떞湲�
//		model.addAttribute("result", "sally"); //1. 泥섎━�븯怨�
//			//return "basic1.jsp"; //2. 寃쎈줈
//		return "basic1";           // prefix [/]  �뙆�씪紐� [basic1] suffix [.jsp]
//			}